/**********************************************************
	...
	Desc:    Camera class
	Original Coder: Matthew Fairfax (extended by panoramix)
...
public:
	...
	struct Material {
		...
		CTexture tex;	// The texture (this is the only outside reference in this class)
...
private:
	...
	void MainChunkProcessor(long length, long findex);
		...
		void EditChunkProcessor(long length, long findex);
			...
			void LightChunkProcessor(long lenght, long findex, int objindex);
