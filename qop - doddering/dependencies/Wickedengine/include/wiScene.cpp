...
namespace wiScene
{
	...
	{
		if (!globalScene) {
			globalScenelock.lock();
			globalScene = new Scene;
			globalScenelock.unlock();
		}
		return *globalScene;
	}

	void wiScene::SetScene(Scene *scene)
	{
		globalScenelock.lock();
		globalScene = scene;
		globalScenelock.unlock();
...
/*				XMFLOAT3 bonepos = bone.GetPosition();
				...
				XMFLOAT3 bonepos = bone.GetPosition();
				AABB boneAABB;
				boneAABB.createFromHalfWidth(bonepos, XMFLOAT3(1, 1, 1));
