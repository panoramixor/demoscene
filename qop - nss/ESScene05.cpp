...
bool CScene05::Load(char *filename)
{
	...
	model.Load("./data/scene05/cualkiera.3ds");
	model.SetFrameRate(200);

	ringblack05.Load("./data/scene05/ringblac.bmp");
...
/* Play */
void CScene05::Play(float sTime, CRenderToTexture *framebuffer)
{
	glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
	model.Draw(sTime);
}

void CScene05::PostRender(float sTime)
{
